...
namespace EzySlice {
	...
	public sealed class SlicedHull {
		...
		public GameObject CreateUpperHull(GameObject original) {
			return CreateUpperHull(original, null, null);
		}

		public GameObject CreateUpperHull(GameObject original, Material crossSectionMat, Material[] newMaterials) {
			...
			if (newObject != null) {
                ...
                {
	                if (newMaterials.Length == shared.Length)
	                {
		                shared = newMaterials;
	                }
	                else
	                {
		                Debug.LogError("Length of newMaterials array not equal Length shared array");
	                }
                }
		...
		public GameObject CreateLowerHull(GameObject original) {
			return CreateLowerHull(original, null, null);
		}

		public GameObject CreateLowerHull(GameObject original, Material crossSectionMat, Material[] newMaterials) {
