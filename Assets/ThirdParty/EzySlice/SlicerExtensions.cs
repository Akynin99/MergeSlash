...
namespace EzySlice {
    ...
    public static class SlicerExtensions {
        ...
        public static GameObject[] SliceInstantiate(this GameObject obj, Plane pl) {
            return SliceInstantiate(obj, pl, new TextureRegion(0.0f, 0.0f, 1.0f, 1.0f), null);
        }

        public static GameObject[] SliceInstantiate(this GameObject obj, Vector3 position, Vector3 direction) {
            return SliceInstantiate(obj, position, direction, null, null);
        }

        public static GameObject[] SliceInstantiate(this GameObject obj, Vector3 position, Vector3 direction, Material[] newMaterials, Material crossSectionMat) {
            return SliceInstantiate(obj, position, direction, new TextureRegion(0.0f, 0.0f, 1.0f, 1.0f), newMaterials, crossSectionMat);
        }

        public static GameObject[] SliceInstantiate(this GameObject obj, Vector3 position, Vector3 direction, TextureRegion cuttingRegion, Material[] newMaterials, Material crossSectionMaterial = null) {
            ...
            return SliceInstantiate(obj, cuttingPlane, cuttingRegion, newMaterials, crossSectionMaterial);
        }

        public static GameObject[] SliceInstantiate(this GameObject obj, Plane pl, TextureRegion cuttingRegion, Material[] newMaterials = null, Material crossSectionMaterial = null) {
            ...
            GameObject upperHull = slice.CreateUpperHull(obj, crossSectionMaterial, newMaterials);
            GameObject lowerHull = slice.CreateLowerHull(obj, crossSectionMaterial, newMaterials);
